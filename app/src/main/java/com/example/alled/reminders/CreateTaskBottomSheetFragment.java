...
import com.example.alled.reminders.AlarmActivity;
...
public class CreateTaskBottomSheetFragment extends BottomSheetDialogFragment{
    ...
    public void setTaskId(int taskId, boolean isEdit, setRefreshListener setRefreshListener, ReminderActivity activity){
        this.taskId = taskId;
        this.isEdit = isEdit;
